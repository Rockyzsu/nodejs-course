...
// const s2 = ' CALMING SERUM 舒敏精华 (15ML) Game'; // work
const s2 = " CALMING SERUM Hello";
const index = s2.search(/[^\x00-\xff]/);
console.log(index);
let englishPart;
let chinesePart;
if (index == -1) {
  ...
  englishPart = s2.slice(0, index).trim();
  chinesePart = s2.slice(index).trim();
}
